...
export default function ChartsTab() {
  ...
  const handleUnblockAccount = async () => {
    try {
      ...
      Alert.alert(
        'Desbloquear Conta',
        'Tem certeza que deseja desbloquear sua conta?',
        [
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.tipsContainer}>
        <Text style={styles.sectionHeader}>Dicas Financeiras</Text>
        <Text style={styles.tip}>• Economize 10% do seu salário mensalmente</Text>
        <Text style={styles.tip}>• Evite compras por impulso</Text>
        <Text style={styles.tip}>• Compare preços antes de comprar</Text>
        <Text style={styles.tip}>• Crie um orçamento mensal</Text>
        <Text style={styles.tip}>• Pague suas dívidas com juros altos primeiro</Text>
      </View>
    </ScrollView>
  );
}
